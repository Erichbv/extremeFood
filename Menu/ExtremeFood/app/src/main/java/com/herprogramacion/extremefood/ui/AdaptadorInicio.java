...
import com.herprogramacion.extremefood.modelo.Comida;
import com.herprogramacion.extremefood.modelo.Restaurantes;
...
public class AdaptadorInicio
    ...
    public int getItemCount() {
        return Comida.RESTAURANTES.size();
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        Restaurantes item = Comida.RESTAURANTES.get(i);
        ...
        viewHolder.nombre.setText(item.getDireccion());
