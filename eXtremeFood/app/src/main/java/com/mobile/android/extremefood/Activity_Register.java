...
public class Activity_Register extends AppCompatActivity {
    ...
    private String FIREBASE_URL = "https://extremefood-2616d.firebaseio.com/";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        inputFemale = (CheckBox) findViewById(R.id.Female);
        inputMale = (CheckBox) findViewById(R.id.Male);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (!name.isEmpty() && !email.isEmpty() && !password.isEmpty() && !sex.isEmpty() && !birthdate.isEmpty()) {

                    registerUser(name, email, password, sex, birthdate,lastname);
    ...
    private void registerUser(final String name, final String email,
                              final String password, final String sex, final String birthdate, final String lastname) {
